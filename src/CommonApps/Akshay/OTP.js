...
//import img2 from './education2.jpg';
...
const App=(props)=> {
   ...
   const handleSubmitOTP = (e) => {
             ...
             console.log("phoneno: ", props.inputfield);
               ...
               if(
                 ...
                 axiosInstance.post(`customtoken/`, {login_identifier: props.inputfield,password: "OLsbd!@#45"+formData.password,})
                        .then((res) => {
                                ...
                                if(location_.includes("registerasstudent")){

				  
				  let redirectlink = basewebURL+"/app/home/slots";	
				  //redirectlink = "http://localhost:3000/app/home/slots";
                                  window.location.href= redirectlink

                                }


                                if(location_.includes("registerastopper")){
