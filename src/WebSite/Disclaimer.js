      ...
      <div className={classes.mainContainer}>
        ...
        <div className={classes.block1}>
          ...
          <div className={classes.details1}>
            The information provided on DiracAI.com is for general
        ...
        <div className={classes.block1}>
          ...
          <div className={classes.details1}>
            The content on DiracAI.com may change without notice. We do not
        ...
        <div className={classes.block1}>
          ...
          <div className={classes.details1}>
            The information on DiracAI.com is not a substitute for
        ...
        <div className={classes.block1}>
          ...
          <div className={classes.details1}>
            ...
            contact us at support@DiracAI.com .
          </div>
        </div>
      </div>
    </div>
