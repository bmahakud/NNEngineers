    ...
    <div className={classes.parent}>
      <div className={classes.mainContainer}>
        ...
        <div className={classes.subtitle}>
          Welcome to DiracAI This Cookies Policy explains how we use cookies and
          similar technologies on our website. By using our platform, you
        ...
        <div className={classes.block1}>
          ...
          <div className={classes.details1}>
            ...
            please contact us at support@DiracAI.com .
          </div>
        </div>
      </div>
    </div>
